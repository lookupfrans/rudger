...
<body oncontextmenu="return false">
  <div class="loader" style="text-align:center;height:100vh; width:100vw;overflow:hidden;background:#000;">
    <img class="image-title" alt="" src="logo_five.png" style="pointer-events:none;margin-top:120px;width: 50%; height:50%;position:absolute;line-heignt:50%;"/>
    <div></div>
  </div>
  <div class="content">
      ...
      <div>
        ...
        <div class="checkout-div" v-show="items.length > 0">
          ...
          <fieldset>
            ...
            <a href="barcode_ru.jpg" download="barcode_ru.jpg" name="mybarcode"
